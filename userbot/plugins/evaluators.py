...
async def _(event):
    ...
    if ("sendmessage" in cmd) or ("sendfile" in cmd) or ("editmessage" in cmd):
        return await edit_delete(event,"__I am not stupid to run this code in public. if you want to use then use it in bot log group.__")
