...
async def send_message(client,
    ...
    if str(chatid) == str(Config.BOTLOG_CHATID):
        return await client.send_message(entity=entity,
                    message=message,
                    reply_to=reply_to,
    ...
    if (
        ...
        if BOTLOG:
            await client.send_message(entity=Config.BOTLOG_CHATID,
                    message=message,
                    reply_to=reply_to,
                    parse_mode=parse_mode,
                    formatting_entities=formatting_entities,
    ...
    return await client.send_message(entity=chatid,
                    message=msg,
                    reply_to=reply_to,
                    parse_mode=parse_mode,
                    formatting_entities=formatting_entities,
...
async def send_file(client,
    ...
    chatid = entity
    if str(chatid) == str(Config.BOTLOG_CHATID):
        return await client.send_file(entity=entity,
                    file=file,
                    caption=caption,
                    force_document=force_document,
                    file_size=file_size,
    ...
    if (
        ...
        if BOTLOG:
            await client.send_file(entity=Config.BOTLOG_CHATID,
                    file=file,
                    caption=caption,
                    force_document=force_document,
                    file_size=file_size,
                    ...
                    **kwargs)
        msg = "Sorry I can't send this information in public chats i will send it in Bot Log group check it from there"
    return await client.send_file(entity=chatid,
                    file=file,
                    caption=msg,
                    force_document=force_document,
                    file_size=file_size,
...
async def edit_message(client, 
    ...
    chatid = entity
    if str(chatid) == str(Config.BOTLOG_CHATID):
        return await client.edit_message(entity=entity,
                        message=message,
                        text=text,
                        parse_mode=parse_mode,
                        formatting_entities=formatting_entities,
    ...
    if (
        ...
        if BOTLOG:
            await client.send_message(entity=Config.BOTLOG_CHATID,
                        ...
                        schedule=schedule)
        msg = "Sorry I can't send this information in public chats i will send it in Bot Log group check it from there"
    return await client.edit_message(entity=chatid,
                        message=message,
                        text=msg,
                        parse_mode=parse_mode,
                        formatting_entities=formatting_entities,
